<x-layouts.app :title="__('FBAR Processing & FATCA Processing')">   
 
  <!-- Header Section -->
  <section class="py-12 bg-white shadow">
    <div class="container mx-auto px-4" data-aos="fade-down">
      <h1 class="text-3xl md:text-4xl font-bold mb-4 text-center text-red-600">FBAR Processing & FATCA Processing</h1>
